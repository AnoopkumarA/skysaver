...
const testimonials = [
  {
    ...
    quote: 'They slashed my Australia ticket by 30%. The process felt personal, fast, and surprisingly fun!',
    verified: true,
    date: '4 days ago'
  },
  {
    ...
    savings: '30%',
    destination: 'Australia',
    quote: 'These guys know where the hidden deals live.',
    verified: true,
    date: '1 week ago'
  },
  {
      ...
      <main>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 lg:gap-8 py-10 max-w-7xl mx-auto">
